  ...
  return (
    <div className="flex flex-col gap-8 w-full h-full">
      ...
      <div className="flex flex-col gap-3 self-center ">
        <div  className="self-center">Don't have an account?<a className="text-primary-500" href="/recruiter/register"> Sign Up</a></div>
        <div  className="self-center">Or</div>
        <div  className="self-center">Are you a candidate?<a className="text-primary-500" href="/candidate/login"> Sign In</a></div>
    </div>
    </div>
  );
}
